...
def get_input_schema_dict(entity: Union[Agent, Team, Workflow]) -> Optional[Dict[str, Any]]:
    """Return the input schema of the given Agent, Team or Workflow as a dictionary"""
    if entity.input_schema is None:
        return None

    try:
        return entity.input_schema.model_json_schema()
    except Exception:
        return None
